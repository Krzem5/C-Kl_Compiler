...
#define assert(ex) \
	do{ \
		if (!(ex)){ \
			KlIo_printf("%s:%d (%s): Assertion Failed: %s\n",__FILE__,__LINE__,__func__,#ex); \
			raise(SIGABRT); \
		} \
	} while (0)
#define assert_msg(ex,msg) \
	do{ \
		if (!(ex)){ \
			KlIo_printf("%s:%d (%s): Assertion Failed: %s: %s\n",__FILE__,__LINE__,__func__,#ex,msg); \
			raise(SIGABRT); \
		} \
	} while (0)
#define _return_0() \
...
enum OPCODE{
	...
	OPCODE_POP=0x01,
	OPCODE_ROT=0x02,
	OPCODE_ROT_THREE=0x03,
	OPCODE_DUP=0x04,
	OPCODE_DUP_TWO=0x05,
	OPCODE_UNARY_ABS=0x06,
	OPCODE_UNARY_NEG=0x07,
	OPCODE_UNARY_INV=0x08,
	OPCODE_UNARY_NOT=0x09,
	OPCODE_UNARY_INC=0x0a,
	OPCODE_UNARY_DEC=0x0b,
	OPCODE_UNARY_LEN=0x0c,
	OPCODE_UNARY_BOOL=0x0d,
	OPCODE_UNARY_REPR=0x0e,
	OPCODE_UNARY_HASH=0x0f,
	OPCODE_BINARY_ADD=0x10,
	OPCODE_BINARY_SUB=0x11,
	OPCODE_BINARY_MLT=0x12,
	OPCODE_BINARY_DIV=0x13,
	OPCODE_BINARY_FDIV=0x14,
	OPCODE_BINARY_MOD=0x15,
	OPCODE_BINARY_MMLT=0x16,
	OPCODE_BINARY_ROOT=0x17,
	OPCODE_BINARY_IROOT=0x18,
	OPCODE_BINARY_LSH=0x19,
	OPCODE_BINARY_RSH=0x1a,
	OPCODE_BINARY_BAND=0x1b,
	OPCODE_BINARY_BXOR=0x1c,
	OPCODE_BINARY_BOR=0x1d,
	OPCODE_BINARY_AND=0x1e,
	OPCODE_BINARY_OR=0x1f,
	OPCODE_BINARY_CONCAT=0x20,
	OPCODE_BINARY_REPEAT=0x21,
	OPCODE_BINARY_ITEM=0x22,
	OPCODE_BINARY_SUBS=0x23,
	OPCODE_BINARY_SUBS_STR=0x24,
	OPCODE_BINARY_INCLUDES=0x25,
	OPCODE_BINARY_ASS=0x26,
	OPCODE_BINARY_CAST=0x27,
	OPCODE_BINARY_INP_ADD=0x28,
	OPCODE_BINARY_INP_SUB=0x29,
	OPCODE_BINARY_INP_MLT=0x2a,
	OPCODE_BINARY_INP_DIV=0x2b,
	OPCODE_BINARY_INP_FDIV=0x2c,
	OPCODE_BINARY_INP_MOD=0x2d,
	OPCODE_BINARY_INP_MMLT=0x2e,
	OPCODE_BINARY_INP_ROOT=0x2f,
	OPCODE_BINARY_INP_IROOT=0x30,
	OPCODE_BINARY_INP_LSH=0x31,
	OPCODE_BINARY_INP_RSH=0x32,
	OPCODE_BINARY_INP_BAND=0x33,
	OPCODE_BINARY_INP_BXOR=0x34,
	OPCODE_BINARY_INP_BOR=0x35,
	OPCODE_BINARY_INP_CONCAT=0x36,
	OPCODE_BINARY_INP_REPEAT=0x37,
	OPCODE_TERNARY_POW=0x38,
	OPCODE_TERNARY_INP_POW=0x39,
	OPCODE_TERNARY_SLICE=0x3a,
	OPCODE_TERNARY_ITEM_ASS=0x3b,
	OPCODE_TERNARY_SUBS_ASS=0x3c,
	OPCODE_QUATERNARY_SLICE_STEP=0x3d,
	OPCODE_QUATERNARY_SLICE_ASS=0x3e,
	OPCODE_QUINTARY_SLICE_STEP_ASS=0x3f,
	OPCODE_CALL=0x40,
	OPCODE_CMP=0x41,
	OPCODE_JMP=0x42,
	OPCODE_RET=0x43,
	OPCODE_EXIT=0x44,
	OPCODE_RAISE=0x45,
	OPCODE_CREATE_ARRAY=0x47,
	OPCODE_CREATE_LIST=0x48,
	OPCODE_JMP_EQ=0x49,
	OPCODE_STORE_GLOBAL=0x4a,
	OPCODE_LOAD_GLOBAL=0x4b,
	OPCODE_DELETE_GLOBAL=0x4c,
	OPCODE_STORE_LOCAL=0x4d,
	OPCODE_LOAD_LOCAL=0x4e,
	OPCODE_DELETE_LOCAL=0x4f,
	OPCODE_LOAD_CONST=0x50,
	OPCODE_LOAD_CONST_CHAR=0x51,
	OPCODE_LOAD_CONST_INT=0x52,
	OPCODE_REF_VAR=0x53
};
